 ...
 * File Description: The Pair class acts as the object that the Max Heap structure will use in order to sort the elements that it's responsible for based on their given importance.
 */

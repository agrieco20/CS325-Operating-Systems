...
public class Simulator {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0;i < numUsers;i++){
            int userProcesses = CentralRandom.getRNG().nextInt(100) + 1; //100
            int userPrograms = CentralRandom.getRNG().nextInt(10) + 1; //10
        ...
        ProcessScheduler ps = new CPU_Scheduler(); //Line updated by Anthony Grieco so that it points at his CPU_Scheduler as opposed to the BasicCPUScheduler
